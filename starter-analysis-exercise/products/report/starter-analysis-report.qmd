...
**Liza Hall contributed to this exercise.**
...
@fig-result2 shows a boxplot produced by one of the R scripts. This plot illustrates the distribution of height for people of different eye colors. In general, people of different eye colors have different distributions in height. People of black eyes have the highest median height, and people of brown eyes have the lowest median height.

```{r}
#| label: fig-result2
#| fig-cap: "Height by Eye Color"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","eye-height.png"))
```

@fig-result3 shows a scatterplot produced by one of the R scripts. This plot illustrates the correlation between weight and age. In general, we observed a linear relationship between weight and age, with a higher weight associated with a higher age.
